...
function addTruck() {
    ...
    const truckHtml = `
        <div class="task" id="task${truckId}">
            ...
            <p><strong>Problema:</strong> <span id="problem${truckId}">Sin especificar</span></p>
...
function setProblem(truckId, problem) {
    document.getElementById(`problem${truckId}`).textContent = problem;
}
